...
require_once ("db.php");
$insert = "Insert into studentattendance values('$id','$sname','$smobile','$class','$gender')";
...
<div class="container">
    ...
    <form action="#" method="post">
        ...
        <input type="number" name="smobile"  required/>0<br>
        <input type="number" name="class"  required/>1<br><br>
